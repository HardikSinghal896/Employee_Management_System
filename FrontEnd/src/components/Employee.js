...
const Employee = ({deleteEmployee,employee}) => {
    ...
    return (
        <tr key={employee.id}>
            ...
            <td className='text-right px-6 py-4 whitespace-nowrap font-medium text-sm'>
                ...
                <button  onClick={(e,id)=>{deleteEmployee(e, employee.id)}} className='text-indigo-600 cursor-pointer hover:text-indigo-800 hover:cursor-pointer'>Delete</button>
            </td>
